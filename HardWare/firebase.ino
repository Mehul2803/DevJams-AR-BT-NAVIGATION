...
uint8_t i = 0;
    if (Firebase.setDouble(firebaseData, path + "/Navigate to/Direction" + (i + 1), i+1))
    {
    ...
    for(i=1;i<=3;i++)
    {
      if (Firebase.setDouble(firebaseData, path + "/Navigate to/Direction" + (i + 1),0))
    {
      Serial.println("PASSED");
      Serial.println("PATH: " + firebaseData.dataPath());
      Serial.println("TYPE: " + firebaseData.dataType());
    ...
    for(i=2;i<=3;i++)
    {
      if (Firebase.setDouble(firebaseData, path + "/Navigate to/Direction" + (i + 1),(i+1)%2))
    {
      Serial.println("PASSED");
      Serial.println("PATH: " + firebaseData.dataPath());
      Serial.println("TYPE: " + firebaseData.dataType());
    ...
    i=3;
      if (Firebase.setDouble(firebaseData, path + "/Navigate to/Direction" + (i + 1),i%2))
    {
      Serial.println("PASSED");
      Serial.println("PATH: " + firebaseData.dataPath());
      Serial.println("TYPE: " + firebaseData.dataType());
